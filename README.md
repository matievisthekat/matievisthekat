...
i recently watched <!--recent.link:start text="recent.title"-->[Se7en](https://imdb.com/title/tt0114369/ 'imdb page')<!--recent.link:end--> and i give it a rating of **<!--recent.rating:start-->8<!--recent.rating:end-->/10**
