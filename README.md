...
## movies
*last updated: <!--common.timestamp:start-->20 december 2021<!--common.timestamp:end-->*

i recently watched <!--recent.link:start text="recent.title"-->[Parasite](https://imdb.com/title/tt6751668/ 'imdb page')<!--recent.link:end--> and i give it a rating of **<!--recent.rating:start-->10<!--recent.rating:end-->/10**
