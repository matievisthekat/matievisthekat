...
## movies
*last updated: <!--common.timestamp:start-->30 may 2023<!--common.timestamp:end-->
[see the code that makes this work](https://github.com/matievisthekat/matievisthekat/tree/master/movies)*

i recently watched <!--recent.link:start text="recent.title"-->[The Lie](https://imdb.com/title/tt7945440/ 'imdb page')<!--recent.link:end--> and i give it a rating of **<!--recent.rating:start-->5<!--recent.rating:end-->/10**
