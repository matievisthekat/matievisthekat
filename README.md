...
## movies
*last updated: <!--common.timestamp:start-->28 november 2021<!--common.timestamp:end-->*
...
the movie <!--favourite.link:start text="favourite.title"-->[Side Effects](https://imdb.com/title/tt7557108/?ref_=ttls_li_i 'imdb page')<!--favourite.link:end--> is one of my favourites. it is a **<!--favourite.genre:start-->Crime, Drama, Mystery<!--favourite.genre:end-->** film with an average rating of **<!--favourite.avgRating:start-->6.7<!--favourite.avgRating:end-->/10**. here's a little description:
