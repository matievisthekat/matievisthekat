...
## movies
*last updated: <!--common.timestamp:start-->16 september 2023<!--common.timestamp:end-->
...
the movie <!--favourite.link:start text="favourite.title"-->[The Boondock Saints](https://imdb.com/title/tt0144117/?ref_=ttls_li_i 'imdb page')<!--favourite.link:end--> is one of my favourites. it is a **<!--favourite.genre:start-->Action, Crime, Thriller<!--favourite.genre:end-->** film with an average rating of **<!--favourite.avgRating:start-->7.7<!--favourite.avgRating:end-->/10**. here's a little description:
